...
This document is a guide to contributing to antarctic
...
## Building antarctic from source

You'll need to build antarctic locally in order to start editing code.
To install antarctic from source, clone the Github
...
To contribute to antarctic, send us pull requests.
For those new to contributing, check out Github's
[guide](https://help.github.com/articles/using-pull-requests/).

Once you've made your pull request, a member of the antarctic
...
If you'd like to add a new feature to antarctic, please do propose your
...
- Read the antarctic source and enhance the documentation,
  or address TODOs
- Browse the [issue tracker](https://github.com/tschm/antarctic/issues),
...
antarctic tests live in the directory `tests`,
